...
# trace-writer sibling static lib (codetracer_trace_writer_nim's build.rs links
# libcodetracer_trace_writer.a from $CODETRACER_NIM_LIB_DIR) via the dev env,
# and exports that path to later steps under GitHub Actions. Shebang recipe so
